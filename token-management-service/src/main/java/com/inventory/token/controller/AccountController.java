...
public class AccountController {
    ...
    @GetMapping("/{platform}")
    public ResponseEntity<List<AccountResponse>> getAccountsByPlatform(@PathVariable("platform") String platform) {
    ...
    public ResponseEntity<AccountResponse> getAccount(@PathVariable("platform") String platform, @PathVariable("username") String username) {
    ...
    public ResponseEntity<Void> deleteAccount(@PathVariable("platform") String platform, @PathVariable("username") String username) {
    ...
    public ResponseEntity<List<AccountResponse>> getUnlockedAccounts(@PathVariable("platform") String platform) {
